...
export { default as MilestonesTab } from "./tabs/MilestonesTab.vue";
export { default as ProjectsTab } from "./tabs/ProjectsTab.vue";
...
export { default as DiscussionsReleasesTab } from "./tabs/DiscussionsReleasesTab.vue";
export { default as ApiDebugTab } from "./tabs/ApiDebugTab.vue";
